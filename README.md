...
一条 **GPU-only 挖矿**的 PoW 公链。ticker: **PTC**。当前处于设计阶段，尚无代码。
...
- **存证 / 锚定**：共识中立，OP_RETURN 80 B 政策收编（兼容 OpenTimestamps）；日常锚 PTC、终局双锚 BTC，链上只放哈希
...
- 设计文档：**[docs/DESIGN.md](docs/DESIGN.md)**（v0.3.6）—— 含威胁模型、Geyser 完整规格、带宽经济学量化、前人算法成败史（Ethash / Kaspa / RandomX / KawPow）与风险登记册
